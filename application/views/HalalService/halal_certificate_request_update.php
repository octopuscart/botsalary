            ...
            <div class="row">
                <div class="kode_contact_field">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <p>
                                I/We hereby apply for a Halal Certificate and to join the fraternity of Halal
                                Certificate
                        ...
                        <form method="post" action="#" id="commentform" class="comment-form"
                            ...
                            <div class="col-md-12 panel panel-inverse">
                                <div class="panel-body">
                                    <div class="form-group col-md-3 halalformfield">
                                        <label for="lable_for_form_date">
                                            Request Date
                                        </label>
                                        <div readonly class="form-control datepicker3"
                                            id="id_for_{name}" value="" ><?php echo $form_id; ?></div>
                                        <input type="hidden" name="form_id" class="form-control datepicker3"
                                            id="id_for_{name}" value="<?php echo $form_id; ?>" placeholder="">
                                    </div>
                                    <div class="form-group col-md-3 halalformfield">
                                        <label for="lable_for_form_date">
                                            Request Date
                                        </label>
                                        <input type="text" name="form_date" class="form-control datepicker3"
                                            id="id_for_{name}" value="<?php echo $form_date; ?>" placeholder="">
                                    </div>
                                    <div class="form-group col-md-3 halalformfield">
                                        <label for="lable_for_form_date">
                                            Request Time
                                        </label>
                                        <input type="text" name="form_time" class="form-control datepicker3"
                                            id="id_for_{name}" value="<?php echo $form_time; ?>" placeholder="">
                                    </div>
                                    <div class="form-group col-md-3 halalformfield" style="background: #ffa100;">
                                        <b> <label for="lable_for_form_date">
                                                Expiry Date
                                            </label>
                                            <input type="text" name="expiry_date" class="form-control datepicker3"
                                                id="id_for_expiry_date" value="<?php echo $expiry_date; ?>"
                                                placeholder="" />
                                        </b>
                            ...
                            <div class="form-group col-md-12 halalformfield">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="applicant_type" id="restaurant"
                                        checked="true" value="Restaurant">
                                    <label class="form-check-label" for="restaurant">Restaurant &nbsp; </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="applicant_type" id="factory"
                                        value="Factory">
                            ...
                            <div class="form-group {base-class} halalformfield">
                                ...
                                <input type="text" name="{name}" class="form-control" id="id_for_{name}"
                                    value="<?php echo $isTest ? "{mock}" : "" ?>" placeholder="">
                            </div>
                            {/hala_form_fields_block1}
                            ...
                            <div class="form-group col-md-7 halalformfield" style="padding-bottom: 34px;">
                                ...
                                <input type="text" name="{name}" class="form-control" id="lable_for_{name}"
                                    placeholder="" value="<?php echo $isTest ? "{mock}" : "" ?>">
                            </div>
                            <div class="form-group col-md-5 halalformfield">
                                <label for="lable_for_{name}">
                                    {filetitle}
                                </label>
                                <input type="file" name="{name}_file" class="form-control" id="lable_for_{name}"
                            ...
                            <div class="form-group {base-class}  halalformfield">
                                ...
                                <textarea name="{name}" maxlength="520" class="form-control" id="lable_for_{name}"
                                    placeholder=""><?php echo $isTest ? "{mock}" : "" ?></textarea>
                                <small>Max char limit 520. 最大字元數限制 520。</small>
                            </div>
                            {/hala_form_fields_block3}

                            <?php
                            foreach ($hala_form_fields_block4 as $h4key => $h4value) {
                                ?>
                                <div class="form-group <?php echo $h4value['base-class']; ?> halalformfield">
                                    <label for="lable_for_<?php echo $h4value['name']; ?>">

                                        <?php echo $h4value['bgtitle']; ?>
                                    </label>
                                    <br />

                                    <?php
                                    foreach ($h4value['elementlist'] as $ekey => $evalue) {

                                        ?>
                                        <div class="<?php echo $evalue['element-class']; ?>">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" <?php echo $evalue['mock'] == "true" ? "Checked" : ""; ?>
                                                    value="<?php echo $evalue['value']; ?>"
                                                    name="<?php echo $evalue['input']; ?>" id="<?php echo $evalue['name']; ?>">
                                                <label class="form-check-label" for="<?php echo $evalue['name']; ?>">
                                                    <?php echo $evalue['title']; ?>
                                                </label>
                                            </div>
                            ...
                            <div class="col-md-12">
                                <p>
                                    ...
                                    documents issued especially for our trade by the Incorporated Trustees of the
                                    Islamic
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group  halalformfield">
                                    ...
                                    <input type="file" name="signature" class="form-control" id="lable_for_signature"
                                        placeholder="" accept="image/*" onchange="loadFile(event)">
                                    <small>Max size 2MB 最大大小 2MB</small>
                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <p class="form-submit"><input name="submit" type="submit"
                                        class="medium_btn background-bg-dark btn_hover hvr-wobble-bottom btn btn-primary"
                                        value="Submit Now"></p>
                            </div>
