    ...
    <div class="">
            ...
            <form action="" method="get">
                <div class="form-group form-group-bg  row form-inline">
                    ...
                    <div class="col-lg-6">
                        ...
                        <a class="btn btn-success" href="<?php echo site_url("Salary/viewAnnualExtraSalaryXls?startYear=$startYear") ?>">
        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-body " id='printArea'>
                <?php
                $this->load->view('Salary/salarylistReportAnnualExtra', array("salary_report" => $salary_report, "salary_date_list" => $salary_date_list, "report_title" => $report_title));
                ?>
            </div>
        </div>
    </div>
