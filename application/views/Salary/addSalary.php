            ...
            <div class="panel-body">
                <form action="#" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6" id='printArea'>
                        ...
                        <?php
                        $this->load->view('Salary/printSalary', array("employee" => $employee, "c_period" => $c_period));
                        ?>
                        ...
                        <!--
                                                <div class="well well-sm">
                                                    <div class="form-group form-inline " >
                                                        <label style="width:310px"><b>Gross Salary</b><br/><small>(Basic+Allowances)-Deduction</small></label>
                                                        <b>  {{salaryData.gross_salary}}</b>
                                                    </div>
                                                    <div class="form-group form-inline " >
                                                        <label style="width:310px"><b>Deductible Salary</b><br/><small>Amount where MPF Applicable</small></label>
                                                        <b> {{salaryData.mpf_deductable_salary}}</b>
                                                    </div>
                                                    <div class="form-group form-inline " >
                                                        <label style="width:310px"><b><?php echo $mpf_percent; ?>% MPF Employee</b><br/><small><?php echo $mpf_percent; ?>% MPF Deduction From Employee</small></label>
                                                        <b> {{salaryData.mpf_employee}}</b>
                                                    </div>
                                                    <div class="form-group form-inline primarytext text-success" >
                                                        <label style="width:310px" class='text-success'><b>Net Salary</b><br/><small>(Basic+Allowances)-(Deduction <?php echo $mpf_percent; ?>% MPF Deduction)</small></label>
                                                        <b> {{salaryData.net_salary}}</b>
                                                    </div>
                        
                        
                                                </div>
                                                <div class="well well-sm">
                                                    <p>MPF Contribution</p>
                                                    <div class="form-group form-inline " >
                                                        <label style="width:310px"><b>Employer</b><br/><small><?php echo $mpf_percent; ?>% MPF Deduction From Employee</small></label>
                                                        <b> {{salaryData.mpf_employer}}</b>
                                                    </div>
                                                    <div class="form-group form-inline " >
                                                        <label style="width:310px"><b>Employee</b><br/><small><?php echo $mpf_percent; ?>% MPF Deduction From Employee</small></label>
                                                        <b> {{salaryData.mpf_employee}}</b>
                                                    </div>
                                                    <div class="form-group form-inline primarytext text-success" >
                                                        <label style="width:310px" class='text-success'><b>Total</b><br/><small> Employee+Employer</small></label>
                                                        <b> {{salaryData.total_mpf}}</b>
                                                    </div>
...
<script src="<?php echo base_url(); ?>assets/angular/salaryController.js"></script>
